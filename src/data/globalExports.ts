...
export const Products: Product[] = [
  {
    id: "hw-01",
    title: "Smart AI Dash Camera (C309)",
    category: "Dashcam Hardware",
    icon: CameraAltIcon,
    imgSrc: "/images/shop/dash-cam-c309.jpg", // Replace with your webp image asset paths
    price: 7300,
    discount: Math.floor(Math.random() * 10) + 10,
    badge: "Safety King",
    specs: [
      "Full HD front-facing recording with wide-angle coverage",
      "Night vision for clear footage in low-light conditions",
      "Loop recording with automatic incident video protection",
      "GPS location and real-time video telemetry integration",
    ],
    description:
      "Protect your fleet with the C309 smart dashcam. Capture clear road footage, monitor driver activity, and preserve critical incident evidence through your FleetMaster dashboard.",
  },
  {
    id: "hw-02",
