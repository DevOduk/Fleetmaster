...
function NewExpenses() {
    ...
    const handleCreate = async (e) => {
        ...
        const res = await createExpense({ ...expenseDetails, currency: profile?.fleetmaster_tenants?.currency, tenant_id: profile.tenant_id });
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-4">
            <section data-v-298b8f5c="" className="page-head">
                <h1 data-v-298b8f5c="" className="text text-2xl font-bold mb-2">Record an expense</h1>
                ...
                <section data-v-79ac9dcd="" data-v-298b8f5c="" className="dc">
                    <header data-v-79ac9dcd="" className="mb-3 border border-brand-700 p-3 rounded-2xl dark:border-brand-400">
                        <div data-v-79ac9dcd="" className="dc-head-main">
                            <div data-v-79ac9dcd="" className="dc-title mb-1">Spend</div>
                    ...
                    <div data-v-79ac9dcd="" className="dc-body space-y-3">
                        <div data-v-298b8f5c="" className="cf-row">
                            ...
                            <div data-v-298b8f5c="" className="cf-control">
                                <Select value={expenseDetails.category} onChange={(e) => setExpenseDetails(prev => ({ ...prev, category: (e), description: expenseCategories.find(v => v.value === e).label }))} options={expenseCategories.map(e => { return { value: e.value, label: e.value } })}></Select>
                            </div>
                        </div>
                        <div data-v-298b8f5c="" className="cf-row">
                        ...
                        <div data-v-298b8f5c="" className="cf-row">
                            ...
                            <div data-v-298b8f5c="" className="cf-control">
                                <Input value={expenseDetails.payment_ref} onChange={(e) => setExpenseDetails(prev => ({ ...prev, payment_ref: (e.target.value) }))} type="text" placeholder="QXJ87YGD6" className="ti-input ti-field ti-mono ti-narrow" />
                            </div>
                        </div>
