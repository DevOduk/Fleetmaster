            ...
            <div className="relative overflow-hidden rounded-3xl bg-gray-50 dark:bg-zinc-900/40 border border-gray-100 dark:border-zinc-800/80 px-6 py-12 sm:p-16 shadow-xs">
                ...
                <div className="relative z-10 max-w-2xl mx-auto space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
                        <button className="w-full sm:w-auto px-6 py-3.5 bg-white dark:bg-zinc-800/40 hover:bg-gray-100 dark:hover:bg-zinc-800 text-sm font-semibold border border-gray-200 dark:border-zinc-700/80 rounded-xl transition-all shadow-xs cursor-pointer dark:text-gray-50">
                            Talk to an expert
                        </button>

                        <button className="group w-full sm:w-auto px-6 py-3.5 bg-black dark:bg-zinc-50 text-white dark:text-zinc-950 text-sm font-medium rounded-xl flex items-center justify-center gap-2 hover:bg-zinc-900 dark:hover:bg-zinc-200 transition-all shadow-md cursor-pointer">
                            Start for free
