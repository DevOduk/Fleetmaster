...
export const EcommerceMetrics = ({
  ...
  // 2. Calculate rates
  const rateThisMonth = getBookingRateForPeriod(
    currentMonth,
    currentYear,
    daysInCurrentMonth,
  );
  const rateLastMonth = getBookingRateForPeriod(
    lastMonth,
    lastMonthYear,
    daysInLastMonth,
  );
  ...
  const completedPercentageChange = calculateChange(
    totalCompletedNow,
