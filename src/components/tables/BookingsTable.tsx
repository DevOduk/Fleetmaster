                      ...
                      <TableRow key={booking.id}>
                        ...
                        <TableCell className="px-5 py-4 text-start sm:px-6">
                          <div className="flex min-w-65 items-center gap-3 pr-3">
                            ...
                            />
                            <div>
                              <span className="text-theme-sm block font-medium text-nowrap text-gray-800 dark:text-white/90">
                        ...
                        <TableCell className="text-theme-sm px-4 py-3 text-nowrap text-gray-500 dark:text-gray-400">
                          Ksh.{" "}
                          {booking.vehicleDetails?.daily_rate?.toLocaleString()}
                        </TableCell>
                        ...
                        <TableCell className="text-theme-sm flex gap-3 px-4 py-3 text-start text-gray-500 dark:text-gray-400">
                          <Link href={"/bookings/" + booking.id + "/edit"}>
                            <button className="text-theme-sm flex items-center justify-center rounded-lg border border-green-500 bg-transparent p-2 px-4 font-medium text-nowrap text-green-500 hover:bg-green-600 hover:text-white">
