...
// Calculate the sliding window of 3 pages
  ...
  const pagesAroundCurrent = Array.from(
    { length: Math.min(3, displayTotalPages) },
    (_, i) => startPage + i
  );
  ...
  return (
    <div className="flex items-center ">
      ...
      <div className="flex items-center gap-2">
        {currentPage > 3 && <span className="px-2 text-gray-700 dark:text-gray-400">...</span>}
        ...
        {currentPage < totalPages - 2 && <span className="px-2 text-gray-700 dark:text-gray-400">...</span>}
      </div>
      <button
        onClick={() => onPageChange(currentPage + 1)}
