        ...
        <section data-v-79ac9dcd="" data-v-298b8f5c="" className="dc">
          ...
          <div data-v-79ac9dcd="" className="dc-body space-y-3">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setExpenseDetails((prev) => ({
                      ...prev,
                      category: e,
                      description: `New payment record for ${paymentsCategories.find((v) => v.value === e).label}`,
                    }))
                  }
                  options={paymentsCategories.map((e) => {
            ...
            <div data-v-298b8f5c="" className="cf-row">
              ...
              <div data-v-298b8f5c="" className="cf-control">
                <Input
                  placeholder="4378 4567 8909 6543"
                  value={expenseDetails.phone}
                  onChange={(v) =>
                    setExpenseDetails((prev) => ({
                      ...prev,
