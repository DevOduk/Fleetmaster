...
export default function ViewPaymentPage({ paymentDetails }: { paymentDetails: any; }) {

    return (
        <div className="max-w-5xl mx-auto space-y-7 py-6">
            <section data-v-298b8f5c="" className="page-head">
                <h1 data-v-298b8f5c="" className="text text-2xl font-bold mb-2 text-black dark:text-white">View Payment</h1>
                ...
                <div data-v-79ac9dcd="" className="dc-body space-y-3">
                    <div data-v-298b8f5c="" className="cf-row">
                        ...
                        <div data-v-298b8f5c="" className="cf-control">
                            <div className='text-gray-600 dark:text-gray-400 text-sm leading-6 p-2 px-4 rounded-lg bg-gray-200 capitalize dark:bg-gray-900'>
                                {paymentDetails?.message?.replace('New payment record for ', '') || 'Payment successful!'} </div>
                        </div>
                    </div>
                    <div data-v-298b8f5c="" className="cf-row">
                        <Label data-v-298b8f5c="" className="cf-lbl">Amount <span data-v-298b8f5c="" className="cf-req" aria-label="required">(KSH)</span>
                        </Label>
                        <div className='text-black dark:text-white p-2 px-4 rounded-lg bg-gray-200 dark:bg-gray-900'> {paymentDetails?.amount?.toLocaleString()} {paymentDetails?.currency} </div>
                    </div>
                    <div data-v-298b8f5c="" className="cf-row">
                        <Label data-v-298b8f5c="" className="cf-lbl">Payment Method</Label>
                        <div data-v-298b8f5c="" className="cf-control">
                            <div className='text-black dark:text-white p-2 px-4 rounded-lg bg-gray-200 dark:bg-gray-900'> {paymentDetails?.provider} </div>
                        </div>
                    </div>
                    <div data-v-298b8f5c="" className="cf-row">
                        <Label data-v-298b8f5c="" className="cf-lbl">Account Number</Label>
                        <div data-v-298b8f5c="" className="cf-control">
                            <div className='text-black dark:text-white p-2 px-4 rounded-lg bg-gray-200 dark:bg-gray-900'> {paymentDetails?.account_number} </div>
                        </div>
                    </div>
                    <div data-v-298b8f5c="" className="cf-row">
                        ...
                        <div data-v-298b8f5c="" className="cf-control">
                            <div className='text-black dark:text-white p-2 px-4 rounded-lg bg-gray-200 dark:bg-gray-900 uppercase'> {paymentDetails?.payment_ref} </div>
                        </div>
                    </div>
                    <div data-v-298b8f5c="" className="cf-row cf-row-stack">
                        ...
                        <div data-v-298b8f5c="" className="cf-control">
                            <div className='text-gray-600 dark:text-gray-400 text-sm leading-6 p-2 px-4 rounded-lg bg-gray-200 capitalize dark:bg-gray-900'>
                                {paymentDetails?.message || 'Payment successful!'} </div>
                        </div>
                    </div>
                </div>
            </section>
