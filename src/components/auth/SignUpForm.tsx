...
export default function SignUpForm() {
  ...
  const [activeStep, setActiveStep] = useState('verify email'); // 'signup' or 'verify email' or 'verify phone'
            ...
            <div>
              <div className="mb-5 sm:mb-8">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  We have sent a verification code to your email address. Please check your inbox and enter the code below to verify your email.
                </p>
              </div>
          ...
          activeStep === 'verify phone' && (
            <div>
              <div className="mb-5 sm:mb-8">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  We have sent a verification code to your phone number. Please check your messages and enter the code below to verify your phone.
                </p>
              </div>
