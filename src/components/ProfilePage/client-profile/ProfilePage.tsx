                        ...
                        <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
                            ...
                            <div className="order-3 xl:order-2">
                                <h4 className="mb-2 text-lg font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">
                                    {profile?.first_name || "First Nmae"} {profile?.last_name || "Last Nmae"}
                                </h4>
                ...
                <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/profile/edit" className='text-nowrap'>
                            <button
                                className="rounded-lg flex gap-2 text-nowrap bg-gray-900 px-4 py-2 text-sm font-semibold text-white transition hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200"
                            >
                                <svg
                                    className="fill-current"
                                    width="18"
                    ...
                    <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                            ...
                            <div>
                                <h3 className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
                                    Bio
                                </h3>
                                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                                    {profile?.bio || "N/A"}
