...
export default function EditSystemUserCard({ userID }: { userID?: string }) {
  ...
  useEffect(() => {
    ...
    if (userID && userID !== profile.id) {
      // meaning the user is not the currently logged in user, so we check for their role and permissions before allowing them to edit the profile
  ...
  return (
    <>
      ...
      {userID && userID !== profile.id && profile?.role !== "Super Admin" ? (
        ...
        <>
              ...
              <div className="flex w-full flex-col items-center gap-6 xl:flex-row">
                <label className="relative h-fit w-fit cursor-pointer overflow-hidden border border-gray-200 p-2 dark:border-gray-800">
                  ...
                  <input
                    ...
                    accept="image/*"
                    onChange={async (e) => {
                      const image = await handleImageFileUpload(
                        e,
                        showToast,
                        "Profiles",
                      );
                ...
                <div className="order-3 xl:order-2">
                  <h4 className="mb-2 text-center text-lg font-semibold text-gray-600 xl:text-left dark:text-gray-400">
                    {profileDetails?.first_name || "First Name"}{" "}
                    {profileDetails?.last_name || "Last Nname"}
                  </h4>
                  <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Joined{" "}
                      {new Date(profileDetails?.created_at).toLocaleString() ||
                        "N/A"}
                    </p>
                  </div>
                </div>
                ...
                <div className="order-2 flex grow items-center gap-2 xl:order-3 xl:justify-end">
                  <a
                    ...
                    rel="noreferrer"
                    href={
                      profileDetails?.socials?.facebook ||
                  ...
                  <a
                    href={profileDetails?.socials?.x || "https://x.com/"}
                    target="_blank"
                    rel="noreferrer"
                    className="shadow-theme-xs flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200"
                  >
                  ...
                  <a
                    href={
                      profileDetails?.socials?.instagram ||
                      "https://instagram.com/"
                    }
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                      <EditableInput
                        ...
                        onChange={(v) =>
                          handleSocialsInputChange("facebook", v)
                        }
                      />
                      <EditableInput
                        ...
                        label="x.com"
                        value={
                          profileDetails?.socials?.x || "https://www.x.com/"
                        }
                        onChange={(v) => handleSocialsInputChange("x", v)}
                      />
                      <EditableInput
                        ...
                        onChange={(v) =>
                          handleSocialsInputChange("linkedin", v)
                        }
                      />
                      <EditableInput
                        ...
                        onChange={(v) =>
                          handleSocialsInputChange("instagram", v)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="custom-scrollbar overflow-y-auto px-2">
                  <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                    ...
                    <EditableInput
                      ...
                      onChange={(v) => handleInputChange("postal_code", v)}
                    />
                    <EditableInput
            ...
            <div className="rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
              <div className="no-scrollbar relative w-full overflow-y-auto rounded-3xl bg-white p-4 lg:p-11 dark:bg-gray-900">
                <div className="px-2 pr-14">
                  ...
                  <p className="mb-6 text-sm text-gray-500 lg:mb-7 dark:text-gray-400">
                    Pick a strong password to keep you safe
                  </p>
                </div>
                  ...
                  <div className="custom-scrollbar overflow-y-auto px-2">
                    <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                      ...
                      <EditableInput
                        ...
                        onChange={(v) =>
                          handleInputChange("confirm_password", v)
                        }
                      />
                    </div>
                  </div>
          ...
          <div className="mt-6 flex items-center gap-3 px-2 lg:justify-end">
            ...
            <Button
              variant="success"
              disabled={
                !profileDetails || profileDetails === originalProfileDetails
              }
              size="sm"
              onClick={handleSave}
            >
  ...
  return (
    <div className="col-span-2 flex flex-col space-y-1 lg:col-span-1">
      ...
      {type === "select" ? (
        ...
        <Input
          placeholder={placeholder}
          error={label === "New Password"}
          hint={
            label === "New Password" &&
            "Password must be atleast 8 characters with a combination of special character, numbers, and letters"
          }
          disabled={disabled}
          type={type}
          value={value || ""}
