...
import { DataViewSchema, getAge, hex } from "../client-profile/ProfilePage";
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
            <div className="flex items-center justify-between">
              ...
              {!pathname.includes('/system-users/clients') &&
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-10">
              <DataViewSchema
                label="First Name"
                value={userDetails?.first_name || "N/A"}
              />
              <DataViewSchema
                label="Last Name"
                value={userDetails?.last_name || "N/A"}
              />
              <DataViewSchema
                label="Email address"
              ...
              <DataViewSchema
                ...
                verified={userDetails?.verification_status?.phone || false}
                action={
                  <button
                    onClick={openModal}
                    className="text-theme-sm mt-3 flex w-full items-center justify-center rounded-lg border border-blue-500 bg-blue-500 p-2 px-4 font-medium text-nowrap text-white hover:bg-blue-600"
          ...
          <div className="rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-10">
              ...
              <DataViewSchema
                label="City/State"
                value={`${userDetails?.city || "N/A"}, ${userDetails?.country || "N/A"}`}
              />
              <DataViewSchema
                label="Postal Address"
                value={userDetails?.postal_code || "N/A"}
              />
              <DataViewSchema label="TAX ID" value={hex(userDetails?.id)} />
            </div>
          </div>
        </div>
      </div>
