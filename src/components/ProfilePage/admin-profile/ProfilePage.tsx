...
function ProfilePage({ userProfile }: { userProfile?: any; }) {
    ...
    const handleVerifyOTP = async () => {
        ...
        const res = await verifyPhoneOTP(btoa(JSON.stringify({ phone, id: profile?.id, otp })),'admin');
    ...
    const handleSendCode = async () => {
        ...
        const res = await sendPhoneVerification(profile?.id, phone, 'admin');
    ...
    const handleResendCode = () => {
        ...
        startTransition(async () => {
            const res = await resendPhoneOTP(profile?.id, btoa(phone),'admin');
                ...
                <div className="space-y-6">
                            ...
                            <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
                                ...
                                <div className="order-3 xl:order-2">
                                    <h4 className="mb-2 text-lg font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">
                                        {userDetails?.first_name || "N/A ..."} {userDetails?.last_name || "N/A"}
                                    </h4>
                                    <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                                        ...
                                        <div className="hidden h-3.5 w-px bg-gray-300 dark:bg-gray-700 xl:block"></div>
                                        <p className="text-sm text-gray-500 dark:text-gray-400">
                                            Joined {new Date(userDetails?.created_at).toLocaleString() || "N/A"}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                        <div className="flex items-center justify-between">
                            ...
                            {
                                (profile?.role === 'Super Admin' || userDetails?.id === profile?.id) &&
                            ...
                            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm flex items-center gap-5 justify-between font-medium text-gray-800 dark:text-white/90">
                                        ...
                                        {
                                            userDetails.verification_status?.email ? <TaskAltOutlinedIcon fontSize="small" className="text-green-500 mt-1" /> : <CancelOutlinedIcon fontSize="small" className="text-red-500 mt-1" />
                                        }
                                    </p>
                                    {
                                        userDetails === profile && (!profile?.verification_status?.email &&
                                ...
                                <div>
                                    ...
                                    <p className="text-sm flex items-center gap-5 justify-between font-medium text-gray-800 dark:text-white/90">
                                        ...
                                        {
                                            userDetails.verification_status?.phone ? <TaskAltOutlinedIcon fontSize="small" className="text-green-500 mt-1" /> : <CancelOutlinedIcon fontSize="small" className="text-red-500 mt-1" />
                                        }
                                    </p>

                                    {
                                        userDetails === profile && (!profile?.verification_status?.phone &&
                                            <button
                                                onClick={openModal}
                                                className="flex mt-3 w-full text-nowrap items-center justify-center p-2 px-4 font-medium text-white rounded-lg bg-blue-500 border border-blue-500 text-theme-sm hover:bg-blue-600"
                                            >
                            ...
                            <div>
                                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                                            {userDetails?.county || "N/A"}, {userDetails?.country || "N/A"}.
                                        </p>
                                    </div>
