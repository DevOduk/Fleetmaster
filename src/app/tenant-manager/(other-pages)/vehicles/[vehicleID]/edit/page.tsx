      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-5">
          <div className="rounded-2xl border border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-gray-900 shadow-sm">
            ...
            <AdminCalendarWrapper bookings={bookings.filter(b => b.vehicle_id === Number(vehicleID))} loading={loading} isMarkedUnavailable={VehicleDetails?.status === "Not Available"} vehicleId={parseInt(vehicleID)} dateString={new Date().toISOString().split('T')[0]} />
            {
