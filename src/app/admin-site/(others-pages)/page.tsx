// app/admin-site/(others-pages)/page.tsx
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (tenantName) {
    title = `Home | ${tenantName}: FleetMaster - Premium Car Rental & Fleet Solutions Software`;
    tenantDescription =
      tenantDescription ||
      `${tenantName} offers top-tier vehicle rentals. Book reliable vehicles across multiple locations easily.`;
  } else {
    title = `Home | FleetMaster - Premium Car Rental & Fleet Solutions Software`;
  }
