...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (tenantName) {
    title = `Expenses | ${tenantName}: FleetMaster - Premium Car Rental & Fleet Solutions Software`;
    tenantDescription =
      tenantDescription ||
      `${tenantName} offers top-tier vehicle rentals. Book reliable vehicles across multiple locations easily.`;
  } else {
    title = `Expenses | FleetMaster - Premium Car Rental & Fleet Solutions Software`;
  }
