...
import ClientResetPassWrapper from "./ClientResetPassWrapper";
...
export async function generateMetadata({
  ...
  return {
    title: `Reset Password | ${tenantName} - Premium Car Rental & Fleet Solutions`,
