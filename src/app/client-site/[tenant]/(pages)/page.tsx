  ...
  return (
    <div>
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 text-center max-w-[700px] m-auto">Browse our extensive collection of well-maintained vehicles. From compact cars to luxury sedans, we have the perfect vehicle for your needs.</p>
