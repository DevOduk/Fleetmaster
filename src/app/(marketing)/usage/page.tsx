    ...
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen">
      ...
      <section className="container mx-auto px-4 py-12 text-center max-w-3xl">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xl mx-auto">
          From independent rental providers to commercial enterprise fleets, explore how our integrated capabilities solve complex daily logistics tasks out-of-the-box.
        </p>
      </section>
      ...
      <main className="container mx-auto px-4 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full items-start">
          ...
          <div className="lg:col-span-8 space-y-12 relative max-w-4xl mx-auto px-4">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-6 space-y-6">
                ...
                {[
                  {
                    ...
                    iconColorClass: 'bg-blue-50 dark:bg-blue-950/50 text-blue-600',
                    title: 'Step 1: Account Registration',
                    description: 'Create your secure master administrator account in under two minutes. No payment method or onboarding parameters are required to configure your development space.'
                  },
                  {
                    stepIcon: DomainAddIcon,
                    iconColorClass: 'bg-purple-50 dark:bg-purple-950/50 text-purple-600',
                    title: 'Step 2: Allocate Subdomain',
                    description: 'Choose your entry routing node name (e.g., yourname.fleetmaster.com). This provisions your isolated database cluster and customer front-end pipeline automatically.'
                  },
                  {
                    stepIcon: LayersIcon,
                    iconColorClass: 'bg-amber-50 dark:bg-amber-950/50 text-amber-600',
                    title: 'Step 3: Select Pricing Tier',
                    description: 'Pick an operational volume model tailored to your fleet active size. Tiers can be scaled up or hot-swapped down fluidly at any time directly from your dashboard billing settings without breaking operations.'
                  },
                  {
                    stepIcon: RocketLaunchIcon,
                    iconColorClass: 'bg-emerald-50 dark:bg-emerald-950/50 text-emerald-600',
                    title: 'Step 4: Live Environment Deployment',
                    description: 'Upload your vehicle profiles, sync integrated eTIMS billing metadata parameters, hook up dispatch parameters, and start collecting bookings globally.'
                  }
                ].map((step, stepIdx) => {
                  ...
                  return (
                    <div key={stepIdx} className="relative flex gap-4 items-start group">
                      ...
                      <div className="pl-4">
                        <h4 className="text-sm font-semibold text-slate-900 dark:text-white transition-colors group-hover:text-brand-500">
                          {step.title}
                        </h4>
            ...
            <div className="bg-slate-900 dark:bg-zinc-900 text-slate-100 rounded-2xl p-6 border border-slate-800">
              <h4 className="font-semibold text-sm text-brand-400 uppercase tracking-wider mb-2">
                Need Help Provisioning?
              </h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                Our support engineering team offers free white-glove setup strategies. We can map legacy operational spreadsheets over to your secure isolated database configuration in real-time.
              </p>
            </div>
          </div>
